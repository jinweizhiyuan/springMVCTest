package com.hqlip.modules.imooc.service.impl;
...
import com.hqlip.modules.imooc.model.Chapter;
...
public class CourseServiceImpl implements CourseService {
	...
	private void wrapChapterList(Integer courseId, List<Chapter> chapterList) {
		...
		chapter.setDescr("Java语言层面对线程的支持，如何创建、启动各停止线程。如何使用常用的线程方法。用隋唐演义理解线程的代码");
		chapterList.add(chapter);
